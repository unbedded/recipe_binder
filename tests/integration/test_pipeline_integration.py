...
from recipe_fmt.generators.pdf_generator import GenerationResult
...
"""
    ...
    @patch('recipe_fmt.pipeline.OpenAIClient')
...
class TestPipelineIntegrationPerformance:
    ...
    def test_pipeline_metrics_accumulation(self, mock_openai_client_class):
        ...
        responses = [
            OpenAIResponse(success=True, data={"content": "yaml1"}, tokens_used=100, cost_estimate=0.002, cached=False),
            OpenAIResponse(success=True, data={"content": "yaml2"}, tokens_used=150, cost_estimate=0.003, cached=True),
            OpenAIResponse(success=True, data={"content": "yaml3"}, tokens_used=120, cost_estimate=0.0025, cached=False)
        ]
