...
DEFAULT_CARD_TEMPLATE = {
    ...
    "card": {
        "size": {"width": 8.5, "height": 4.0, "orientation": "landscape"},
    ...
    "display": {
        ...
        "ingredients": {
            "columns": {
                "ingredient": {"width": "50%", "alignment": "left", "label": "Ingredient"},
                "amount": {"width": "15%", "alignment": "right", "label": "Amount"},
                "unit": {"width": "10%", "alignment": "left", "label": "Unit"},
                "weight": {
                    "width": "15%",
                    "alignment": "right",
                    "label": "Weight",
    ...
    "colors": {
        ...
        "text": {"primary": "#000000", "secondary": "#666666", "accent": "#333333"},
        "background": {"card": "#FFFFFF", "alternate_row": "#F5F5F5", "banner": "category_color"},
    },
    "layout_sections": {
        "front": [
        ...
        "back": [{"type": "instructions", "height": "75%"}, {"type": "notes", "height": "25%"}],
    },
}
...
COMPACT_CARD_TEMPLATE = {
    ...
    "card": {
        "size": {"width": 6.0, "height": 4.0, "orientation": "landscape"},
    ...
    "typography": {
        ...
        "ingredient": {"font_name": "Helvetica", "font_size": 8, "space_after": 1},
        "instruction": {"font_name": "Helvetica", "font_size": 8, "space_after": 2},
    },
    "display": {
        "show_weights": False,
        "show_purpose": False,
...
MINIMAL_CARD_TEMPLATE = {
    ...
    "card": {
        "size": {"width": 5.0, "height": 3.0, "orientation": "landscape"},
        "margins": {"top": 0.1, "bottom": 0.1, "left": 0.1, "right": 0.1},
        "layout": "ingredients_only",
    },
    "typography": {
        "title": {"font_name": "Helvetica", "font_size": 12, "alignment": "left"},
        "ingredient": {"font_name": "Helvetica", "font_size": 8},
    },
    "display": {
        "show_weights": False,
        "show_purpose": False,
...
LARGE_FORMAT_TEMPLATE = {
    ...
    "card": {
        "size": {"width": 11.0, "height": 8.5, "orientation": "landscape"},
    ...
    "typography": {
        ...
        "ingredient": {"font_name": "Times", "font_size": 12, "space_after": 3},
        "instruction": {
            "font_name": "Times",
            "font_size": 12,
            "alignment": "justify",
...
INVALID_TEMPLATE_DATA = {
    "missing_template_info": {
        ...
        "card": {"size": {"width": 8.5, "height": 4.0}}
    },
    "invalid_dimensions": {
...
EDGE_CASE_TEMPLATES = {
    ...
    "unicode_template": {
        ...
        "card": {"size": {"width": 8.5, "height": 4.0}},
        "colors": {"category_colors": {"Café": "#8B4513", "Dessért": "#FF69B4"}},
    },
}

# Template with All Layout Types - For layout testing
ALL_LAYOUT_TYPES = {
    "two_sided": {"template_info": {"name": "Two Sided Layout"}, "card": {"layout": "two_sided"}},
    "single_sided": {
...
def get_edge_case_template_names() -> list[str]:
    ...
    """
    return ["maximum_values", "minimum_values", "unicode_template"]
...
TEMPLATE_FILE_CONTENT = {
    ...
    + "# Auto-generated YAML content for "
    + f"{template.get('template_info', {}).get('name', 'Unknown Template')}\n"
