...
from recipe_fmt.generators.pdf_generator import (
    PDFCardGenerator, GenerationResult, CardLayout, CategoryColors,
    create_generator
)
...
class TestCategoryColors:
    ...
    def test_all_categories_have_colors(self):
        ...
        expected_categories = {
            'Meat', 'Side', 'Main', 'Soup', 'Sauce', 
            'Breakfast', 'Salad', 'Baking', 'Dessert', 'Other'
        }
...
class TestPDFCardGeneratorGeneration:
    ...
    def test_successful_pdf_generation(self, mock_doc_class):
        ...
        with patch.object(Path, 'stat') as mock_stat:
            mock_stat.return_value.st_size = 15000  # 15KB file
...
class TestPDFCardGeneratorContentBuilding:
    ...
    def test_header_section_building(self):
        ...
        with patch('recipe_fmt.generators.pdf_generator.Paragraph') as mock_paragraph, \
             patch('recipe_fmt.generators.pdf_generator.Spacer') as mock_spacer:
    ...
    def test_ingredients_section_building(self):
        ...
        with patch('recipe_fmt.generators.pdf_generator.Paragraph') as mock_paragraph, \
             patch('recipe_fmt.generators.pdf_generator.Table') as mock_table:
    ...
    def test_category_banner_building(self):
        ...
        with patch('recipe_fmt.generators.pdf_generator.Table') as mock_table, \
             patch('recipe_fmt.generators.pdf_generator.Paragraph') as mock_paragraph:
...
class TestPDFCardGeneratorEdgeCases:
    ...
    def test_recipe_with_very_long_title(self):
        ...
        long_title_recipe = Recipe(
            title="This is an extremely long recipe title that exceeds normal length limits and should be handled gracefully by the PDF generator without causing layout issues",
            category="Other",
            servings=1,
    ...
    def test_recipe_with_many_ingredients(self):
        ...
        with patch('recipe_fmt.generators.pdf_generator.SimpleDocTemplate') as mock_doc_class:
            ...
            with patch.object(Path, 'stat') as mock_stat:
                mock_stat.return_value.st_size = 20000
...
class TestPDFCardGeneratorFactoryFunction:
    ...
    def test_create_generator_with_custom_params(self):
        ...
        generator = create_generator(
            show_weights=False,
            layout=CardLayout.SINGLE_SIDED
        )
