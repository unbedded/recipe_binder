...
from recipe_fmt.validators.yaml_validator import (
    YAMLValidator, ValidationResult, ValidationError, ValidationSeverity,
    create_validator
)
...
class TestYAMLValidatorBusinessRules:
    ...
    def test_category_validation_valid(self):
        ...
        valid_categories = ["Meat", "Side", "Main", "Soup", "Sauce", 
    ...
    def test_ingredient_count_validation(self):
        ...
        many_ingredients = [{"ingredient": f"ingredient_{i}", "amount": 1, "unit": "cup"} 
                          for i in range(60)]
        yaml_data_many = {
...
class TestYAMLValidatorNutritionValidation:
    ...
    def test_nutrition_validation_basic_checks(self):
        ...
        nutrition_negative = Nutrition(calories=-100)
        recipe = Recipe(
            title="Test Recipe",
            category="Other",
            servings=4,
        ...
        assert "cannot be negative" in nutrition_warnings[0].message
        
        # Test very high calories
        nutrition_high = Nutrition(calories=3000)
        recipe.nutrition = nutrition_high
    ...
    def test_nutrition_validation_disabled(self):
        ...
        # Create recipe with invalid nutrition data
        nutrition = Nutrition(calories=-500)  # Invalid
        recipe = Recipe(
            title="Test Recipe",
            category="Other",
            servings=4,
...
class TestYAMLValidatorStatistics:
    ...
    def test_validation_stats(self):
        ...
        expected_categories = {"Meat", "Side", "Main", "Soup", "Sauce", 
                             "Breakfast", "Salad", "Baking", "Dessert", "Other"}
    ...
    def test_validation_result_summary(self):
        ...
        result.warnings = [
            ValidationError(ValidationSeverity.WARNING, "field3", "Warning message 1")
        ]
        ...
        result_warnings_only.warnings = [
            ValidationError(ValidationSeverity.WARNING, "field", "Warning")
        ]
