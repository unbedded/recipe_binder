...
from recipe_fmt.templates.template_engine import (
    TemplateEngine, CardTemplate, TemplateError, LayoutType,
    TypographyStyle, CardDimensions, DisplayOptions, ColumnConfig,
    create_engine
)
from recipe_fmt.templates.template_loader import (
    TemplateLoader, TemplateInfo, DefaultTemplates, create_loader
)
...
class TestTemplateEngineTemplateLoading:
    ...
    def test_load_valid_template(self):
        ...
        template_data = {
            ...
            "typography": {
                "title": {"font_size": 18, "alignment": "center"}
            },
            "display": {
                "show_weights": True,
...
"""
    ...
    def test_load_template_with_absolute_path(self):
        ...
        template_data = {
            "template_info": {"name": "Absolute Path Template"}
        }
    ...
    def test_validate_invalid_margins(self):
        ...
        invalid_template = CardTemplate(
            dimensions=CardDimensions(
                ...
                margin_top=-1, margin_bottom=-1  # Invalid
            )
        )
