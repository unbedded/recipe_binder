...
class OpenAIConfig(BaseSettings):
    ...
    api_key: str | None = Field(None, env="OPENAI_API_KEY", description="OpenAI API key")
    ...
    model_config = {
        ...
        "json_schema_extra": {
            "example": {
                "debug": False,
                "log_level": "WARNING",
                "display": {"show_weights": True, "weight_unit": "grams", "show_nutrition": False},
                "openai": {"model": "gpt-4o-mini", "max_tokens": 2000, "temperature": 0.1},
            }
        },
    }
