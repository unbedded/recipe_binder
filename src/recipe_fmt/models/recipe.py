...
class Ingredient(BaseModel):
    ...
    weight_grams: Optional[int] = Field(None, ge=0, description="Weight in grams for precision weighing")
    purpose: Optional[str] = Field(None, description="Ingredient's role in recipe (base, seasoning, etc.)")
...
class Nutrition(BaseModel):
    ...
    sodium_mg: Optional[int] = Field(None, ge=0, description="Sodium in milligrams")
...
class Recipe(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=500, description="Brief recipe description")
    ...
    cook_time: Optional[str] = Field(None, description="Cooking time (e.g., '15 minutes')")
    total_time: Optional[str] = Field(None, description="Total time including prep and cooking")
    ...
    notes: Optional[list[str]] = Field(None, description="Additional recipe notes or tips")
    
    # Additional metadata fields
    difficulty: Optional[str] = Field(None, description="Recipe difficulty level (Easy, Medium, Hard)")
    ...
    source: Optional[str] = Field(None, description="Recipe source or attribution")
